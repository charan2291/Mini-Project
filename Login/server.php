...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($username)) { array_push($errors, "<p>Username is required</p>"); }
  if (empty($email)) { array_push($errors, "<p>Email is required<p>"); }
  if (empty($password_1)) { array_push($errors, "<p>Password is required</p>"); }
    ...
    if (count($errors) == 0) {
        ...
        if (mysqli_num_rows($results) == 1) {
          ...
          header('location: index.php');
            ...
            array_push($errors, "<p>Invaild username/password</p>");
        }
    }
  }
